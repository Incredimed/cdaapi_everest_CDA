...
namespace MARC.Everest.DataTypes
{
    ...
    public class II : ANY, IInstanceIdentifier, IEquatable<II>
    {
        ...
        /// <summary>
        /// The 'patientIdStatus' is an NHS localisation
        /// </summary>
        [Property(Name = "patientIdStatus", PropertyType = PropertyAttribute.AttributeAttributeType.Structural, Conformance = PropertyAttribute.AttributeConformanceType.Optional)]
        [XmlAttribute("patientIdStatus")]
        public string PatientIdStatus { get; set; }
