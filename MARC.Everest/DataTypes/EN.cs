...
namespace MARC.Everest.DataTypes
{
    ...
    public enum EntityNameUse
    {
        ...
        Search,
        /// <summary>
        /// NHS Extension : PREVIOUS MAIDER
        /// </summary>
        [Enumeration(Value = "PREVIOUS-MAIDEN")]
        [XmlEnum("PREVIOUS-MAIDEN")]
        PreviousMaiden,
        /// <summary>
        /// NHS Extension : PREVIOUS-BIRTH
        /// </summary>
        [Enumeration(Value = "PREVIOUS-BIRTH")]
        [XmlEnum("PREVIOUS-BIRTH")]
        PreviousBirth,
        /// <summary>
        /// NHS Extension : PRWVIOUS BACHELOR
        /// </summary>
        [Enumeration(Value = "PREVIOUS-BACHELOR")]
        [XmlEnum("PREVIOUS-BACHELOR")]
        PreviousBachelor,
        /// <summary>
        /// NHS Extension : PREVIOUS
        /// </summary>
        [Enumeration(Value = "PREVIOUS")]
        [XmlEnum("PREVIOUS")]
        Previous,
        /// <summary>
        /// NHS Extension : PREFERRED
        /// </summary>
